...
# Custom pixel-art tile set (generated by tools/generate_tile_icons.py). Each
# plugin maps to a subject "key"; the actual PNG is per-theme:
#   assets/icons/tile icons/TechDeck pixel/<theme>/<key>.png
# Keyed on the RUNTIME plugin id (e.g. the 911_batch_repeater folder ships id
# "911_repeater"). The art is bundled with the build via the spec's assets entry.
PLUGIN_ICON_KEYS = {
    "911_setup":            "clipboard",
    "911_repeater":         "refresh",
    "911_remove_ticket":    "scissors",
    "911_po_pdf_extractor": "invoice",
    "911_sketch_extractor": "picture",
    "911_linear_inch_calc": "ruler",
...
def _load_pixel_icon(plugin, size: int) -> QPixmap | None:
    ...
    pixel_dir = _tile_icons_dir() / "TechDeck pixel"
