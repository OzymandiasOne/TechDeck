...
class RogueModePlayer(QDialog):
    ...
    def _build_ui(self):
        ...
        self._elapsed_lbl.setStyleSheet("font-size: 11px; background: transparent; color: #888;")
        self._total_lbl = QLabel("0:00")
        self._total_lbl.setStyleSheet("font-size: 11px; background: transparent; color: #888;")
        ...
        self._vol_lbl.setStyleSheet("background: transparent; font-size: 11px; color: #888;")
        vol_row.addStretch()
