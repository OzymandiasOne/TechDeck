...
below cell by cell. It's a four-arm design (90 degrees apart) so it's perfectly
symmetric. Colours come from the active theme palette so it fits the theme. The
grid is rendered to a pixmap once; spinning just rotates that pixmap with
smoothing OFF, so the pixels stay hard-edged at every angle.
...
Editing the art — each cell is one character:
    ...
    W  wing  -> theme accent_two        (the four lobes / "wings")
...
spins. Keep every row the same length.
...
SPINNER_ART = [
    ...
    "....WWRRRRWW.....BBRRRRRBB.....WWRRRRWW....",
    "...WWRRRRRRWWBBBBBRRR.RRRBBBBBWWRRRRRRWW...",
    "..WWRR....RRWWBBBRR.....RRBBBWWRR....RRWW..",
    "..WWR......RWWBBBRR.....RRBBBWWR......RWW..",
    "..WRR......RRWBBBR.......RBBBWRR......RRW..",
    "..WWR......RWWBBBRR.....RRBBBWWR......RWW..",
    "..WWRR....RRWWBBBRR.....RRBBBWWRR....RRWW..",
    "...WWRRRRRRWWBBBBBRRR.RRRBBBBBWWRRRRRRWW...",
    "....WWRRRRWW.....BBRRRRRBB.....WWRRRRWW....",
