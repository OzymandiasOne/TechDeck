...
911 Linear Inches | Reads a batch's nest DXFs and package PDFs and computes the exact linear inches of cut per part, per nest, and per batch (part cut length from the DXF geometry, quantity from the nest summary), exported to one Excel report 
