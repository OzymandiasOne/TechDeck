...
911 Baked Beans Wild Ride | Consolidates a folder of filled NC-calc pricing sheets into one review list (DYPN, Total Bevels, Total Complex Bevels, Total Cut Lin per part + totals row), saved into that same folder named with the batch + nest number 