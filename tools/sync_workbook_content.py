...
PI_NEW = [
    ("DRAWING DIMENSION READER", "PILOT",
     ...
     "PACKAGE -- INCLUDING THE WELD PREP CALLOUTS -- AND WRITES THEM OUT FOR "
     "THE INSPECTION SHEETS; RUNS ENTIRELY ON "
     "THE MACHINE WITH NO OUTSIDE SERVICE, SKIPS REFERENCE-ONLY FIGURES AND "
     "STOCK NOTES, AND FLAGS ANY DRAWING IT COULD NOT READ"),
